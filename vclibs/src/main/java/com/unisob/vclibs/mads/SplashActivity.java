...
public class SplashActivity extends ADS_SplashActivity {
    ...
    public static void Show_Exite_Dialog(Activity activity){
        ...
        rate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                activity.startActivity(new Intent("android.intent.action.VIEW").setData(Uri.parse("https://play.google.com/store/apps/details?id=" + activity.getPackageName())));
            }
        });
